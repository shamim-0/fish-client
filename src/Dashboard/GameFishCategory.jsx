...
const GameFishCategory = () => {
    ...
    const handleAddCategory = (e) => {
        ...
        fetch('http://localhost:5000/game-fish-category-post', {
            method: "POST",
            headers: {
    ...
    const handleDeleteCategory = (_id)=>{
        const url =  `http://localhost:5000/game-fish-category-delete?_id=${_id}`
        fetch(url, {
            method: "DELETE"
        })
        .then(res=> res.json())
    ...
    return (
        <div className='p-5'>
            <h2 className='text-xl font-medium my-5 text-center title'>Add Game Fish Category</h2>
            <div>
...
export default GameFishCategory;