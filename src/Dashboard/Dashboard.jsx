        ...
        <div className='flex '>
            ...
            <div className='w-72 bg-[#1e2d47]  text-sm'>
                ...
                <ul className=''>
                    ...
                    <Link className='flex justify-start items-cent er  text-gray-100 px-5 hover:bg-[#324970] py-3' to='/dashboard/event-category'><TripOriginIcon className='mini-icon' /> Event  Category</Link>
                ...
                <ul className='rounded'>
                    ...
                    <Link className='flex justify-start items-center py-3 text-gray-100 px-5 hover:bg-[#324970] ' to='/dashboard/create-event'><TripOriginIcon className='mini-icon' /> Create Event </Link>
                    <Link className='flex justify-start items-center py-3 text-gray-100 px-5 hover:bg-[#324970] ' to='/shboard/create-event'><TripOriginIcon className='mini-icon' /> Event  Category</Link>
                ...
                <Link className='flex justify-start items-center py-3 text-gray-100 px-5 hover:bg-[#324970] ' to='/dashboard/create-venue'> <TripOriginIcon className='mini-icon' /> Add Value</Link>
                </ul>
                <ul className=''>
